          ...
          <div className="container">
            ...
            <form onSubmit={this.handleSearch.bind(this)}>
              <div class="row">
                ...
                <button type="submit" className="btn btn-succuss">
                  Search
                </button>
              </div>
            </form>
          ...
          <thead className="">
            <tr>
              {this.props.headers.map(header => {
                if (header == 'Category') {
                  return (
                    <th key={header} className="category">
                      {header}
                    </th>
                  );
                } else if (header == 'Title') {
                  return (
                    <th key={header} className="title">
                      {header}
                    </th>
                  );
                } else if (header == 'Price') {
                  return (
                    <th key={header} className="price">
                      {header}
                    </th>
                  );
                } else if (header == 'Location') {
                  return (
                    <th key={header} className="location">
                      {header}
                    </th>
                  );
                } else if (header == 'Date') {
                  return (
                    <th key={header} className="date">
                      {header}
                    </th>
                  );
                } else if (header == 'Stat') {
                  return (
                    <th key={header} className="stat">
                      {header}
                    </th>
                  );
                }
            ...
            {this.props.data.map((row, index) => {
              return (
                <tr key={index}>
                  ...
                  <td className="title">
                    <a href={'/boards/' + row['id']}>{row['title']}</a>
                  </td>
                  <td className="price">
